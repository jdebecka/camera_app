...
class LandingImagePage extends StatefulWidget {
  @override
  _LandingImagePageState createState() => _LandingImagePageState();
}

class _LandingImagePageState extends State<LandingImagePage> {
  File imageFile;
